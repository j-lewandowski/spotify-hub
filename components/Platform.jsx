    ...
    >
      ...
      <div className="w-full h-full bg-neutral-800 flex flex-col  items-center justify-center p-4 rounded-lg text-white hover:cursor-pointer hover:outline hover:outline-2 hover:outline-offset-4 hover:outline-secondary duration-150">
        <div className="w-full h-full flex items-end justify-around">
          <div className="bg-secondary w-full column ease-in-out duration-700 max-h-[40%] rounded-t-lg relative c2">
          ...
          <div className="bg-secondary w-full shadow-platform column ease-in-out duration-700 max-h-[50%] rounded-t-lg relative c1 z-20">
          ...
          <div className="bg-secondary w-full column ease-in-out duration-700 max-h-[30%] rounded-t-lg relative c3">
